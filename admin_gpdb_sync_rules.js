    ...
    cards: [
      {
        ...
        items: [
          ...
          "Use <b>One-off player check</b> (same card) to look up by name and compare/apply selected fields without interrupting the bulk job.",
          "Progress is <b>checkpointed in the DB</b> — reload the page and Start again with <b>Resume</b> checked.",
          "SQL: <code>gpdb_pesdb_playstyle_att_def_20260820.sql</code> + <code>gpdb_pesdb_one_off_player_20260822.sql</code> + redeploy <code>gpdb-pesdb-scrape</code>.",
        ],
      },
      {
        heading: "Scrape pace",
