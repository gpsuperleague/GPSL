    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          ...
          "Unrenewed / unbid expiry players become GPDB free agents: Central Bank pays MV (<code>contract_expiry_compensation</code>), not a foreign sale. Former club cannot re-sign them — run split patches <code>contract_expiry_fa_central_bank_01…04c.sql</code> (not the combined file; SQL Editor often fails with Failed to fetch).",
