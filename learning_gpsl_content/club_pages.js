  ...
  blocks: [
    {
      ...
      items: [
        ...
        `<b><a href="stadium.html">Stadium</a></b> — capacity, attendance estimate, upcoming home gates, expansion; also eFootball home-venue rules (licensed vs Konami stadium).`,
        `<b><a href="matchday.html">Match Day</a></b> — submit scores, player stats, and your match squad (after kick-off is agreed and both owners have checked in); console rules include stadium setup.`,
