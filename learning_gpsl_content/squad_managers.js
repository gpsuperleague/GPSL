  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        ...
        `<b>List / sack</b> — available in <b>June, July, and January</b> (not August — fixtures have started), and only from <b>mid first spell</b>: summer signing → first chance in <b>January</b>; January signing → next <b>June–July</b>. From Squad or Club Details. Sack pays half market value (once per season).`,
        `<b>No instant list or sack</b> — you cannot list or sack a manager you just signed; wait until mid-spell as above.`,
