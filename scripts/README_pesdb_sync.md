...
1. **Detect pages** — expect ~19k Dream Team Standard / ~779 pages
...
- List: `https://pesdb.net/efootball/players/?availability=standard`
  (Dream Team · Standard players only — not Authentic, not Featured/Epic/specials)
