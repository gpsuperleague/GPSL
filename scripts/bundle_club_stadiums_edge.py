#!/usr/bin/env python3
"""Bundle stadium_stadiumdb.js into index.ts for single-file Supabase Dashboard deploy."""

from pathlib import Path
import re

ROOT = Path(__file__).resolve().parents[1]
STADIUM = ROOT / "stadium_stadiumdb.js"
HANDLER = ROOT / "supabase/functions/club-stadiums-sync/handler.ts"
OUT = ROOT / "supabase/functions/club-stadiums-sync/index.ts"
...
def main() -> None:
    stadium = strip_exports(STADIUM.read_text(encoding="utf-8"))
