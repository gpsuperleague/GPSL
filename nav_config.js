...
export const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: true, label: "Games" },
      {
        href: "fantasy.html",
        label: "GP Fantasy League",
        page: "fantasy",
        indent: true,
      },
      {
      ...
      { heading: true, label: "Info" },
      {
        href: "owner_profile.html",
        label: "My Profile",
        page: "owner_profile",
        indent: true,
      },
      {
        href: "waiting_list.html",
        label: "Waiting List",
        page: "waiting_list",
        indent: true,
      },
