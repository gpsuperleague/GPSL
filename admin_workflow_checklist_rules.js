    ...
    cards: [
      {
        ...
        items: [
          ...
          "<b>Season Break</b> — GPDB sync/dedup, auction exclusions, kits, weather, nation setup / clear assignments.",
          "<b>Create Season</b> — Create Pre-Season (contract tick + ledger), then GPDB season exclusions, prize money, divisions, calendar, go live, fixtures, cups.",
