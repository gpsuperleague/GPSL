...
export const SQUAD_TIPS = {
  ...
  manager:
    "Your club manager. Rating sets a season finish target for your division. Miss both seasons of a 2-season deal and they leave for market value (2-season rehire ban). Hit ≥1 target and you may renew — renew by August or they are released for market value.\n\nList / Sack only in June, July, and January (not August). Sack costs half market value (once per season) and needs mid-spell tenure. List puts them on the Manager Transfer Market.\n\nNo manager? You cannot check in or play fixtures until one is signed.",
