...
-- Manual qualifiers (CH 16v17 shield/bowl playoffs before draw)
CREATE TABLE IF NOT EXISTS public.competition_cup_manual_qualifiers (
  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  season_id bigint NOT NULL REFERENCES public.competition_seasons (id) ON DELETE CASCADE,
  cup_code text NOT NULL CHECK (cup_code IN ('shield', 'bowl')),
  ...
  qualifier_role text NOT NULL CHECK (qualifier_role IN ('shield_playoff_winner', 'bowl_playoff_loser')),
  created_at timestamptz NOT NULL DEFAULT now(),
