-- =============================================================================
-- club_fixtures_my_club — include agreed kick-off for season calendar
--
-- Adds schedule_status + agreed_kickoff_at (from competition_fixture_schedule).
-- Club full names were already returned; calendar UI will use them.
--
...
COMMENT ON FUNCTION public.club_fixtures_my_club() IS
  'Current-season fixtures for the logged-in club, including schedule_status and agreed_kickoff_at.';
