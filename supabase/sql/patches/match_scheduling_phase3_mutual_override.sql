-- =============================================================================
-- Match scheduling — Phase 3 (mutual kick-off override: play now / new time)
-- Run after match_scheduling_phase2.sql (+ fixture_schedule_accept_already.sql)
-- Both clubs must confirm; no reschedule or emergency allowance is consumed.
--
-- DEADLOCK? The full script locks hot tables while the app is live. Either:
--   1. Close GPSL tabs, wait ~30s, retry once; OR
--   2. Run the three step files IN ORDER (recommended):
--        match_scheduling_phase3_step1_schema.sql
--        match_scheduling_phase3_step2_functions.sql
--        match_scheduling_phase3_step3_inbox.sql
-- =============================================================================

-- ---------------------------------------------------------------------------
-- Schema (inbox types moved to step3 — run step files if this deadlocks)
-- ---------------------------------------------------------------------------
...
-- Inbox message types: see match_scheduling_phase3_step3_inbox.sql
-- (kept out of this file to avoid deadlocks with live inbox traffic)
...
-- Run match_scheduling_phase3_step3_inbox.sql for inbox types + NOTIFY pgrst
