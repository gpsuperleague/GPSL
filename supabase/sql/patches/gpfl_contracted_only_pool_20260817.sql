-- =============================================================================
-- GPFL: player pool — only currently contracted league players
-- Live check against Players.Contracted_Team + competition_club_seasons divisions.
-- Safe re-run. After gpfl_pool_club_owner_20260817.sql (and formations patch ok).
-- =============================================================================
...
BEGIN
  ...
  -- Keep FA flags in sync so stale free agents drop out of the board
...
-- Block adding anyone who is not currently contracted in a GPFL division
