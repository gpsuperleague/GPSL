-- =============================================================================
-- Club season checklist: add home-grown (HG) count
-- Nation match vs club Nation (same rule as check_club_squad_composition).
-- Run after admin_club_season_checklist_nation.sql. Safe re-run.
-- =============================================================================
