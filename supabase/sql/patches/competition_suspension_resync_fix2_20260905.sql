-- =============================================================================
-- Suspension resync repair v2
--
-- Fixes duplicate (suspension_id, sequence_no) errors when some ban slots were
-- already served. We now preserve served sequence numbers and only refill the
-- remaining ones.
--
  ...
  LOOP
    ...
    IF v_remaining > 0 THEN
      ...
      LOOP
        ...
        VALUES (v_row.id, v_fx.fixture_id, v_served_count + v_fx.seq, false)
