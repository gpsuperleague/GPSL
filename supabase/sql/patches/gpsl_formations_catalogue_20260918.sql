...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM public.gpsl_formation_slots WHERE formation_id = v_id) THEN
    ...
    INSERT INTO public.gpsl_formation_slots (formation_id, slot_key, default_position, x, y, sort_order, allow_relabel, allowed_positions) VALUES (v_id, 'CMF', 'CMF', 50.0, 52.0, 6, true, ARRAY['CMF']::text[]);
