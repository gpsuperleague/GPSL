-- =============================================================================
-- Scouting tactic board: 16 bench slots (12 subs + 4 squad fillers)
-- Pitch 11 + bench 16 = 27 planning squad. Match Day stays 11 + 12.
-- Safe re-run. Replaces prior max-17 check.
-- =============================================================================
...
BEGIN
  ...
  END IF;
  IF v_bench_count > 16 THEN
    RAISE EXCEPTION 'Maximum 16 on bench (12 subs + 4 squad)';
  END IF;
