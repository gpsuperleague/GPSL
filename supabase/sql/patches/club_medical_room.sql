...
CREATE TABLE IF NOT EXISTS public.club_medical_centre (
  ...
  specialist_tokens int NOT NULL DEFAULT 0 CHECK (specialist_tokens >= 0 AND specialist_tokens <= 20),
  updated_at timestamptz NOT NULL DEFAULT now()
);

-- Cap may already exist without upper bound — tighten safely
DO $cap$
BEGIN
...
-- ---------------------------------------------------------------------------
-- Hire physio (gender assigned at random)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Hire doctor (gender assigned at random)
-- ---------------------------------------------------------------------------
