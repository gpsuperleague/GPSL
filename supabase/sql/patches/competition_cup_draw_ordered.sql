-- =============================================================================
-- Cup draw ceremony: optional fixed player order from animated client shuffle.
-- Run after competition_cup_byes_bracket_fix.sql
-- =============================================================================
...
GRANT EXECUTE ON FUNCTION public.competition_build_knockout_bracket(bigint, text, text[], text[], text[]) TO authenticated;
GRANT EXECUTE ON FUNCTION public.competition_draw_prestige_cup(bigint, text, text[]) TO authenticated;
GRANT EXECUTE ON FUNCTION public.competition_draw_league_cup(bigint, text[]) TO authenticated;
