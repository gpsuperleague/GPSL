...
function wikiTitleFromUrlOrName(input) {
...
function absoluteWikiImageUrl(src) {
  if (!src) return null;
 ...
 */
function parseWikipediaKitStacks(html) {
...
async function fetchWikipediaParseHtml(pageTitle, fetchImpl = fetch) {
 ...
 */
async function compositeWikiKitPng(stack, opts) {
 ...
 * @param {{ fetchImpl?: typeof fetch, Image: any, scale?: number }} opts
 */
async function fetchWikipediaKitPngs(pageTitleOrUrl, opts) {
