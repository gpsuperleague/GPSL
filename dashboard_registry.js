...
const TILE_IMAGE_BY_ID = {
  ...
  bookies: `${PANEL_BG}/Finances.png`,
  fantasy: `${PANEL_BG}/Finances.png`,
...
export const DASHBOARD_PANELS = [
  ...
  p("club_challenges", "Challenges", "club_challenges.html", { defaultOn: true }),
  ...
  p("owners_shop", "Owners Shop", "owners_shop.html"),
  p("admin_owners_shop", "Owners Shop Admin", "admin_owners_shop.html", { adminOnly: true }),
  p("fantasy", "GP Fantasy League", "fantasy.html"),
  p("learning_gpsl", "Learning GPSL", "learning_gpsl.html"),
  p("login", "Login", "login.html"),
  p("join_gpsl", "Join GPSL (Discord)", "join_gpsl.html"),
  ...
  p("owner_last_login", "Owner Last Login", "owner_last_login.html"),
  ...
  p("admin_international_selection_open", "Open Nation Selection", "admin_international_selection_open.html", { adminOnly: true }),
