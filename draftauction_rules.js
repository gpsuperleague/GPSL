...
export function getDraftAuctionRules() {
  return {
    ...
    cards: [
      {
        heading: "1 · Earn a credit",
        items: [
          "In <a href=\"GPDB.html\">GPDB</a>, be the <b>first</b> club to place a Draft Offer on a free agent.",
          "That opening bid earns you a credit for later.",
        ],
      },
      {
        heading: "2 · Join or raise here",
        items: [
          "Each player you join costs <b>1 draft credit</b>.",
          "You cannot join with <b>zero</b> credits — <a href=\"GPDB.html\">earn one in GPDB</a> first.",
      ...
      },
      {
        ...
        items: [
          "Draft closes with a random finish after <b>6pm UK</b> on Day 2.",
      ...
      },
      {
        ...
        items: [
          ...
          "Filter by name, club, bids, scouting, attrs, bid / wage.",
          "<b>Hide</b> declutter; <b>Show hidden</b> restores (bids unchanged).",
        ],
      },
    ],
  };
