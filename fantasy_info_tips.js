/**
 * GPFL page owner-help tip copy (hover / focus) — same system as squad.html.
 */
...
export const GPFL_TIPS = {
  ...
  monthScores:
    "Per GPSL month: points, transfer hits, chip used, and whether the month is still provisional or final.",
  ...
  topTransfers:
    "Most common in/out moves for the selected GPSL month among GPFL managers.",
