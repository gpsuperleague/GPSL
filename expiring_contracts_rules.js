    ...
    cards: [
      ...
      },
      {
        ...
        items: [
          ...
          `Championship club taking a Super League player also pays <b>${CHAMP_SL_SIGNING_FEE_PCT}% of market value</b> to the player as a signing-on fee (shown on the market for Championship owners).`,
